...
public class Calculating {
    ...
    public void operation(double real1, double real2, double imagin1, double imagin2, int numsAfterDot){
        operations.calculate(real1, real2, imagin1, imagin2, numsAfterDot);
